...
void GameOverStage::render()
{
	...
	switch (stage) {
		case 0:
			...
			break;
		case 1:
			renderBackground(Texture::Get("data/quad_textures/gameover/enter_name.tga"));
			...
			break;
		case 2:
			renderBackground(Texture::Get("data/quad_textures/gameover/bg.tga"));
...
Texture* GameOverStage::getEndingTexture() {
	if (nights_survived == 0 && ranking_pos != -1)
		...
		return Texture::Get("data/quad_textures/gameover/neutral_ending.tga");
}
